...
class App:
    def __init__(self,nome:str,endereco:str):
        ...
        #
        self.combo_curso = ttk.Combobox(self.janela, font='Tahoma 14 bold',values=["Java","Python","HTML"], width=21,state="readonly")
        ...
        ############# BUTTONS ###############
        self.btn_adicionar = Button(self.janela, text ="Adicionar",font = "Tahoma 12 bold", width=7, fg="red", command= self.addAluno)
        self.btn_adicionar.grid(row=5, column=0)

        self.btn_Editar = Button(self.janela, text ="Editar",font = "Tahoma 12 bold", width=7, fg="red",)
        self.btn_Editar.grid(row=5, column=1)

        self.btn_Remover = Button(self.janela, text ="Remover",font = "Tahoma 12 bold", width=7, fg="red",)
        self.btn_Remover.grid(row=5, column=2)

        self.btn_listar = Button(self.janela, text ="Listar",font = "Tahoma 12 bold", width=7, fg="red",)
        self.btn_listar.grid(row=5, column=2)
    ...
    def atualizarTabela(self):
        ...
        for aluno in self.escola.lista_alunos:
